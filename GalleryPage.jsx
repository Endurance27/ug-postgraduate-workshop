          ...
          {PHOTOS.map((p, i) => (
            ...
            >
              ...
              <div style={{
                ...
                background: "linear-gradient(transparent 55%, rgba(15,35,71,0.82))",
              ...
              >
                <div>
                  <p style={{ color: "#fff", fontSize: 13, fontWeight: 600, margin: 0 }}>{p.caption}</p>
                  <p style={{ color: "rgba(255,255,255,0.65)", fontSize: 11, margin: 0 }}>{p.year} Workshop</p>
                </div>
              </div>
            </div>
          ))}
      ...
      {lightbox !== null && (
        <div onClick={() => setLightbox(null)} style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{ maxWidth: 900, width: "100%", textAlign: "center" }}>
            ...
            <p style={{ color: "#fff", marginTop: 14, fontSize: 15, fontWeight: 600 }}>{PHOTOS[lightbox].caption}</p>
