...
export default function ContactPage({
  ...
  const website = contact.website || "dcs.ug.edu.gh/workshop";
  const location =
    contact.location ||
    ...
    <main>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-ug-navy to-ug-blue text-white py-[72px] pb-14">
        <div
          ...
          style={{
            backgroundImage: `url('${images.networking || `${import.meta.env.BASE_URL}images/collaboration-networking.jpeg`}')`,
          }}
        />
        <div className="container relative z-10">
          ...
          <p className="text-white/75 text-base">
            Reach the Workshop Planning Committee — we respond within 2–3
            working days
          </p>
        </div>
      </section>
      ...
      <div className="container section">
        {submitted ?
          <div className="max-w-[520px] mx-auto text-center">
            <div className="text-[64px] mb-5 flex justify-center">
              <Mail size={64} color="#1B3A6B" />
            </div>
            <h2 className="mb-3">Thank you, {form.name.split(" ")[0]}!</h2>
            <p className="text-[#555] leading-[1.75] mb-6">
              Your message has been received. The Workshop Planning Committee
              will respond to <strong>{form.email}</strong> within 2–3 working
              days.
            </p>
            <button
        ...
        : <div
            className="grid gap-12 items-start contact-grid"
          ...
          >
            <form onSubmit={handleSubmit}>
              <div className="card">
                ...
                <button
                  type="submit"
                  className="btn-primary w-full justify-center text-[15px] py-[13px]"
                >
            ...
            <div className="flex flex-col gap-5">
              <div className="rounded-2xl overflow-hidden relative">
                <img
                  src={
                    images.networking ||
                    `${import.meta.env.BASE_URL}images/collaboration-networking.jpeg`
                  }
                  alt="DCS Department"
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(transparent 40%, rgba(15,35,71,0.85))",
                  }}
                >
              ...
              <div className="card">
                ...
                {[
                  ...
                  <div
                    key={i}
                    className={`flex gap-3 pb-3 mb-3 ${i < 4 ? "border-b border-[#f5f5f5]" : ""}`}
                  >
                    <span className="flex-shrink-0 mt-0.5 text-ug-blue">
                      {c.icon}
                    </span>
                    <div>
                      <div className="text-[11px] font-semibold text-[#888] uppercase tracking-[0.06em] mb-0.5">
                        {c.label}
                      </div>
                      <div className="text-[13px] text-[#333] leading-[1.6] whitespace-pre-line">
                        {c.value}
                      </div>
                    </div>
                  </div>
              ...
              <div className="card bg-ug-blue-light border-none">
                <h4 className="mb-2.5 font-serif text-[0.95rem]">
                  Quick Connect
                </h4>
                <a
